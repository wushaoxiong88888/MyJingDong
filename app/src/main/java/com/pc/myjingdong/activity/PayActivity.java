...
import com.pc.myjingdong.pay.PayResult;
import com.pc.myjingdong.pay.SignUtils;
...
//	private static final String URL_JSON = "http://169.254.63.148:8080/alipayServer/AlipayDemo";
    ...
    private ImageView mPayIvBack;
    private TextView mPayTvPrice;
    /**
     * 立即支付
     */
    private Button mPayBtPay;
    /**
     * 支付宝
     */
    private CheckBox mPayAli;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPayTvPrice.setText(allPrice);

    }

    private void initView() {
        mPayIvBack = (ImageView) findViewById(R.id.pay_iv_back);
        mPayIvBack.setOnClickListener(this);
        mPayTvPrice = (TextView) findViewById(R.id.pay_tv_price);
        mPayBtPay = (Button) findViewById(R.id.pay_bt_pay);
        mPayBtPay.setOnClickListener(this);
        mPayAli = (CheckBox) findViewById(R.id.pay_ali);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.pay_iv_back:
                finish();
                break;
            case R.id.pay_bt_pay:
