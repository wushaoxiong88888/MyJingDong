...
public class AddAddressModel {
    ...
    public void addaddrgetData(String uid, String addr, String phone, String name, String token, final OnNetListener onNetListener){
        ...
        Observable<BaseBean> observable = apiService.addAddress(uid, addr, phone, name, token);
